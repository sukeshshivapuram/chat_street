...
class DbBackup(models.Model):
                ...
                try:
                    ...
                    if rec.send_mail_sftp_fail:
                        try:
                            ...
                            response_mail = "odoov13_25@%s" % catch_all_domain if catch_all_domain else self.env.user.partner_id.email
    ...
    def _take_dump(self, db_name, stream, model, backup_format='zip'):
        ...
        cron_user_id = self.env.ref('odoov13_25.backup_scheduler').user_id.id
